...
// by derived classes
    public DungeonCharacter(String character) {

        this.name = CharacterSheet.getName(character);
        this.hitPoints = CharacterSheet.getHP(character);
        this.attackSpeed = CharacterSheet.getAttackSpeed(character);
        this.chanceToHit = CharacterSheet.getChanceToHit(character);
        this.damageMin = CharacterSheet.getDamageMin(character);
        this.damageMax = CharacterSheet.getDamageMax(character);
